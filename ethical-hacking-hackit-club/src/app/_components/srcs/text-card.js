...
export const TextRevealCard = ({
  ...
  return (
    <div
      ...
      ref={cardRef}
      className={`bg-[#1d1c20] w-[80rem] p-8 relative overflow-hidden ${className}`}
    >
      {children}
      ...
      <div className="relative flex items-center h-40 overflow-hidden">
        ...
        <div className=" overflow-hidden [mask-image:linear-gradient(to_bottom,transparent,white,transparent)]">
          <p className="text-base sm:text-[3rem] py-10 font-bold bg-clip-text text-transparent bg-[#555555]">
            {text}
          </p>
          <MemoizedStars />
        </div>
